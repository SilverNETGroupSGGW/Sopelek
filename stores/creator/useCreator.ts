...
export function useCreator(key: string = 'default') {
  return defineStore(`creator_${key}`, {
    state: () => ({
    // Data
      ...
      subjectsPositions: [] as CreatorSubject[],
    ...
    actions: {
      ...
      calculatePosition(subject: SubjectResult): CreatorSubject {
